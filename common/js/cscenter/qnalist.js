var targetUrl = "/common/component/cscenter/AjaxQnalist.aspx";
    ...
    for (var i = 0; i < bArr.length; i++) {
        ...
        if (currentPage - 1 == i) {
            ...
            for (var j = 0; j < aArr.length; j++) {
                ...
                sHtml += "<tr onclick='$(location).attr(\"href\", \"/view/cscenter/qnaDetail.aspx?seq=" + data[aArr[j]]["SEQ"] + "\");' >";
                sHtml += "  <td>" + data[aArr[j]]["NO"] + "</td>";
                sHtml += "  <td> <p class='qnatitle'>" + data[aArr[j]]["TITLE"] + "</p></td>";
                sHtml += "  <td>" + data[aArr[j]]["ENTDT"] + "</td>";
                sHtml += "  <td>" + data[aArr[j]]["STATUSNM"] + "</td>";
                sHtml += "</tr>";
